...
$.ajax({
              ...
              success: function(res) {
                ...
                draw_bar(data, 'education_chart', 'Education Level Distribution', 'Count of Survey Participants', 'Educational Level');
              }
          });
...
$.ajax({
  ...
  $.ajax({
              ...
              success: function(res) {
                ...
                draw_bar_stacked(data, 'gender_div_selection', '', 'Training');
              }
          });
  ...
  //               for(var i=0; i< res.length; i++){
  //                   data.push([res[i][0], 
  //                     res[i][1], res[i][1],// (res[i][1]/(res[i][1]=res[i][2]+res[i][3]+res[i][4]+res[i][5]+res[i][6]+res[i][7]+res[i][8]+res[i][9]+res[i][10]+res[i][11]+res[i][12])*100).toFixed(1), 
  //                     res[i][2], res[i][2], // (res[i][2]/(res[i][1]=res[i][2]+res[i][3]+res[i][4]+res[i][5]+res[i][6]+res[i][7]+res[i][8]+res[i][9]+res[i][10]+res[i][11]+res[i][12])*100).toFixed(1),
  //                     res[i][3], res[i][3],// (res[i][3]/(res[i][1]=res[i][2]+res[i][3]+res[i][4]+res[i][5]+res[i][6]+res[i][7]+res[i][8]+res[i][9]+res[i][10]+res[i][11]+res[i][12])*100).toFixed(1),
  //                     res[i][4], res[i][4], // (res[i][4]/(res[i][1]=res[i][2]+res[i][3]+res[i][4]+res[i][5]+res[i][6]+res[i][7]+res[i][8]+res[i][9]+res[i][10]+res[i][11]+res[i][12])*100).toFixed(1),
  //                     res[i][5], res[i][5], // (res[i][5]/(res[i][1]=res[i][2]+res[i][3]+res[i][4]+res[i][5]+res[i][6]+res[i][7]+res[i][8]+res[i][9]+res[i][10]+res[i][11]+res[i][12])*100).toFixed(1),
  //                     res[i][6], res[i][6], // (res[i][6]/(res[i][1]=res[i][2]+res[i][3]+res[i][4]+res[i][5]+res[i][6]+res[i][7]+res[i][8]+res[i][9]+res[i][10]+res[i][11]+res[i][12])*100).toFixed(1),
  //                     res[i][7], res[i][7], //(res[i][7]/(res[i][1]=res[i][2]+res[i][3]+res[i][4]+res[i][5]+res[i][6]+res[i][7]+res[i][8]+res[i][9]+res[i][10]+res[i][11]+res[i][12])*100).toFixed(1),
  //                     res[i][8], res[i][8], //(res[i][8]/(res[i][1]=res[i][2]+res[i][3]+res[i][4]+res[i][5]+res[i][6]+res[i][7]+res[i][8]+res[i][9]+res[i][10]+res[i][11]+res[i][12])*100).toFixed(1),
  //                     res[i][9], res[i][9], //(res[i][9]/(res[i][1]=res[i][2]+res[i][3]+res[i][4]+res[i][5]+res[i][6]+res[i][7]+res[i][8]+res[i][9]+res[i][10]+res[i][11]+res[i][12])*100).toFixed(1),
  //                     res[i][10], res[i][10], //(res[i][10]/(res[i][1]=res[i][2]+res[i][3]+res[i][4]+res[i][5]+res[i][6]+res[i][7]+res[i][8]+res[i][9]+res[i][10]+res[i][11]+res[i][12])*100).toFixed(1),
  //                     res[i][11], res[i][11], //(res[i][11]/(res[i][1]=res[i][2]+res[i][3]+res[i][4]+res[i][5]+res[i][6]+res[i][7]+res[i][8]+res[i][9]+res[i][10]+res[i][11]+res[i][12])*100).toFixed(1),
  //                     res[i][12], res[i][12], //(res[i][12]/(res[i][1]=res[i][2]+res[i][3]+res[i][4]+res[i][5]+res[i][6]+res[i][7]+res[i][8]+res[i][9]+res[i][10]+res[i][11]+res[i][12])*100).toFixed(1)
  //                     ]);
  //               }
